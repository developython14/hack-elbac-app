...
class freefire extends StatefulWidget {
  ...
  @override
  State<freefire> createState() => _MyAppState();
}
...
class device_data extends StatefulWidget {
  const device_data({Key? key}) : super(key: key);

  @override
  State<device_data> createState() => _device_dataState();
}

class _device_dataState extends State<device_data> {
  static final DeviceInfoPlugin deviceInfoPlugin = DeviceInfoPlugin();
  Map<String, dynamic> _deviceData = <String, dynamic>{};
